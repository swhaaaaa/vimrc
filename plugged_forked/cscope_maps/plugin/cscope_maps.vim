...
if has("cscope")
	...
	" Just for fun
	nmap <Leader><Leader>ss :cs find s 
	nmap <Leader><Leader>gg :cs find g 
	nmap <Leader><Leader>cc :cs find c 
	nmap <Leader><Leader>tt :cs find t 
	nmap <Leader><Leader>ee :cs find e 
	nmap <Leader><Leader>ff :cs find f 
	nmap <Leader><Leader>ii :cs find i 
	nmap <Leader><Leader>dd :cs find d 
